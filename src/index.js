      ...
      <div>
        ...
        <div className="row">
          <div className="col-sm-2">
            <h1><img className="img-responsive" src={<Card card= {this.state.hand[0]} /></h1>
          </div>
          <div className="col-sm-2">
            <h1><img className="img-responsive" src={<Card card= {this.state.hand[1]} /></h1>
          </div>
          <div className="col-sm-2">
            <h1><img className="img-responsive" src={<Card card= {this.state.hand[2]} />></h1>
          </div>
          <div className="col-sm-2">
            <h1><img className="img-responsive" src={<Card card= {this.state.hand[3]} /></h1>
          </div>
          <div className="col-sm-2">
            <h1><img className="img-responsive" src={<Card card= {this.state.hand[4]} /></h1>
          </div>
          <div className="col-sm-2">
